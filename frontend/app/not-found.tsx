    ...
    <main className="mx-auto max-w-[1600px] px-4 py-16 sm:px-6">
      <section className="max-w-2xl">
        ...
        <div className="mt-8 grid gap-3 sm:grid-cols-2">
          <Link href="/" className="rule block py-3 transition hover:text-accent">
            <p className="font-semibold">Find your representatives</p>
            <p className="mt-1 text-sm text-stone-500">Enter your postal code — MP, MPP and councillor.</p>
          </Link>
          <Link href="/ask" className="rule block py-3 transition hover:text-accent">
            <p className="font-semibold">Ask a question</p>
            <p className="mt-1 text-sm text-stone-500">Type a problem, see who is responsible.</p>
          </Link>
          <Link href="/bills" className="rule block py-3 transition hover:text-accent">
            <p className="font-semibold">Browse bills</p>
            <p className="mt-1 text-sm text-stone-500">Every federal bill, in plain language.</p>
          </Link>
          <Link href="/votes" className="rule block py-3 transition hover:text-accent">
            <p className="font-semibold">Browse votes</p>
            <p className="mt-1 text-sm text-stone-500">What the House decided, vote by vote.</p>
          </Link>
        </div>
