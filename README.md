...
| Ontario MPP expenses | ola.org members' expense-disclosure CSVs (monthly) |
| Ontario lobbying | Ontario Lobbyist Registry, Office of the Integrity Commissioner (weekly; registrations, not meeting logs) |
| BC lobbying | ORL open-data CSVs — per-meeting Lobbying Activity Reports since 2020 + registrations since 2010 (monthly) |
